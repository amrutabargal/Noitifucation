...
const Login = () => {
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      ...
      if (!validateEmail(formData.resetEmail.trim())) {
      ...
      const response = await fetch(`${API_URL}/auth/forgot-password`, {
        ...
        body: JSON.stringify({ email: formData.resetEmail.trim() }),
      });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-dark-950 via-dark-900 to-dark-800 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center relative z-10">
        ...
        {/* Direct Google Login Button - Only ONE */}
        <AnimatePresence mode="wait">
          {!showEmailForm && !showRegister && !showForgotPassword ? (
            <motion.div
              key="google"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <motion.button
                ...
                className="w-full bg-gradient-to-r from-white to-gray-50 hover:from-gray-50 hover:to-white border-2 border-gray-200 hover:border-royal-400 text-gray-800 font-bold py-5 px-6 rounded-2xl transition-all duration-300 shadow-xl hover:shadow-2xl hover:shadow-royal-500/20 flex items-center justify-center gap-4 text-lg group"
              >
                <motion.div
                ...
                <span className="group-hover:tracking-wide transition-all">Continue with Google</span>
                <motion.span
                  animate={{ x: [0, 5, 0] }}
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-gradient-to-br from-dark-900/90 to-dark-800/90 text-gray-500 font-medium">OR</span>
                </div>
              </div>
              ...
              <motion.button
                ...
                className="w-full bg-gradient-to-r from-dark-800/80 to-dark-700/80 hover:from-dark-700/90 hover:to-dark-600/90 text-royal-300 hover:text-royal-200 font-semibold py-4 px-6 rounded-xl border-2 border-royal-500/30 hover:border-royal-400/50 transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-royal-500/20 flex items-center justify-center gap-2"
              >
                ...
                <div className="text-center mt-4">
                  <p className="text-gray-400 text-sm">
                    ...
                    <motion.button
                      ...
                      className="text-royal-400 hover:text-royal-300 font-semibold transition-colors"
                    >
                      Login
                    </motion.button>
                  </p>
            ...
            >
              ...
              {!showForgotPassword ? (
                    ...
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <motion.button
                        ...
                        onClick={() => {
                          ...
                          setFormData({ ...formData, resetEmail: formData.email });
                        }}
                ...
                <form onSubmit={handleForgotPassword} className="space-y-4">
                  <div className="mb-4">
                    <h3 className="text-lg font-semibold text-gray-200 mb-2">Reset Password</h3>
